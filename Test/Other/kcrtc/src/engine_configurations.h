...
/*Maybe will use it in future, now disable it*/
...
#define WEBRTC_CODEC_G729  //jkh
#define WEBRTC_CODEC_SILK //tadaya
#define WEBRTC_CODEC_AMR  //added by Rambo.Fu 2013-8-15

// ----------------------------------------------------------------------------
//  [Video] Codec settings
// ----------------------------------------------------------------------------

//#define VIDEOCODEC_I420 //jkh

/*xiongfei add 2013 0423*/
...
#if defined (WEBRTC_VIDEO) || defined (__APPLE__) || defined (_WIN32)
