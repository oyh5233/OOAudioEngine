...
enum TraceModule
{
    ...
    //add for module "sip","linphone" //jkh
    kTraceSip			= 0x0020,
    kTraceLinPhone	= 0x0021,	    
};
...
{
	// current gilbert q value add by Rookie 20130408 for emodel (Q14)
	WebRtc_UWord16 currentGilbertQ;
...
{
    kVideoCodecVP8,
    kVideoCodecH264,/*xf added 2013 0416*/
    kVideoCodecI420,
    kVideoCodecRED,
    kVideoCodecULPFEC,
    kVideoCodecUnknown
